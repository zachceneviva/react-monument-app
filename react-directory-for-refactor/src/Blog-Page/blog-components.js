  ...
  return (
    <div className="Blog">
      <header className="vertical-center">
	    ...
	    <nav>
	    	<a className="hamburger" href="https://www.google.com/"><i className="fa fa-bars"></i></a>
	    	<ul>
	    ...
	    <div className="wrap grid-wrapper">
	    	...
	    	<aside>
	    		...
	    		<h3>Recent Issues</h3>
	    		<ul>
	    			<li><a href="https://www.google.com/">Issue Nineteen &mdash; Camping</a></li>
	    			<li><a href="https://www.google.com/">Issue Eighteen &mdash; Food</a></li>
	    			<li><a href="https://www.google.com/">Issue Seventeen &mdash; Signs</a></li>
	    			<li><a href="https://www.google.com/">Issue Sixteen &mdash; Friends</a></li>
	    			<li><a href="https://www.google.com/">Issue Fifteen &mdash; Carnivals</a></li>
	    			<li><a href="https://www.google.com/">Issue Fourteen &mdash; Gatherings</a></li>
	    		</ul>
	    	</aside>
